...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-03-2022 a las 18:54:04
...
(1, '[value-2]tobias', '[value-3]cordoba', 0, 0, '[value-6]campa123', 0, '0000-00-00'),
(2, 'Facundo', 'Barrera', 45693877, 2147483647, 'BarrioSmata2', 17, '2017-05-02'),
(3, '[value-2]consuelo', '[value-3]cordoba', 0, 0, '[value-6]la capilla', 0, '0000-00-00'),
(4, 'Facundo ', 'Barrera', 45693877, 2147483647, 'barriosmata5', 17, '2015-08-22'),
(5, '[value-2]milagros ', '[value-3]barrera', 0, 0, '[value-6]smata5', 0, '0000-00-00');
